...
#if FEATURE_CONTROLLER == CONTROLLER_RADDS || FEATURE_CONTROLLER == CONTROLLER_SMARTRAMPS || FEATURE_CONTROLLER == CONTROLLER_DAVINCI_20A
...
#if FEATURE_CONTROLLER == CONTROLLER_DAVINCI_20A
#undef DISPLAY_DRIVER
#define DISPLAY_DRIVER DRIVER_20x4
#define LCD_CONNECTOR LCD_CONNECTOR_4BIT_PARALLEL
#define UI_ROWS 4
...
//#define UI_LINE_OFFSETS {0,0x20,0x40,0x60} // 4x20 with KS0073
#define UI_LINE_OFFSETS \
    { 0, 0x40, 0x10, 0x50 } // 4x20 with HD44780
#define LCD_CHAR_ENCODING LCD_CHAR_ENCODING_HD44870_KNJI
#endif
    ...
    || FEATURE_CONTROLLER == CONTROLLER_REPRAPDISCOUNT_GLCD || FEATURE_CONTROLLER == CONTROLLER_SMARTRAMPS
...
#define ENCODER_MAX_REPEAT_STEPS 5
#endif
#ifndef ENCODER_MAX_REPEAT_TIME_MS
#define ENCODER_MAX_REPEAT_TIME_MS 35
#endif
#ifndef ENCODER_MIN_REPEAT_TIME_MS
#define ENCODER_MIN_REPEAT_TIME_MS 15
#endif
#ifndef ENCODER_APPLY_REPEAT_STEPS_IN_MENUS
#define ENCODER_APPLY_REPEAT_STEPS_IN_MENUS 1
#endif
